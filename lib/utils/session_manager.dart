...
class SessionManager {
  ...
  Future<void> saveSession(
      int val, String id_user, String username, String fullname, String jenis_kelamin, String no_hp, String alamat, String email, String role, String created, String updated) async {
    ...
    pref.setString("created", created);
    pref.setString("created", updated);
  }
